  ...
  renderPickerItemCenter () {
    ...
    return (
      <div className='picker-items-col picker-items-col-center'>
        <div className='picker-items-col-wrapper' style={{transform: `translate3d(0px, ${90 - (selectIndex * 36)}px, 0px)`}}>
  ...
  renderPickerItemLeft () {
    ...
    return (
      <div className='picker-items-col picker-items-col-center' style={{width: '50%'}}>
        <div className='picker-items-col-wrapper' style={{transform: `translate3d(0px, ${90 - (selectParentIndex * 36)}px, 0px)`}}>
          {formattedValues.map((object, index) => {
            return (
